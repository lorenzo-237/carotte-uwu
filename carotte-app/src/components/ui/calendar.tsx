  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month_caption: 'flex justify-center pt-1 relative items-center font-semibold tracking-wide',
        month_grid: 'w-full border-collapse space-y-1',
        caption_label: 'text-sm font-medium',
        nav: 'flex items-center justify-between absolute inset-x-0 top-4 md:top-0',
        button_previous: cn(
